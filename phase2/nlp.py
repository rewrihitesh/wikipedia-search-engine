...
class preProcessor():
	...
	def tokenise(self,data,regex=r'\b[1-9][0-9]{1,3}\b|\b[a-z]+\b'):
		import re
		data=data.lower()
		tokens=[]
	...
	def tokenisStopWordsStemming(self,data,regex=r'\b[1-9][0-9]{1,3}\b|\b[a-z]+\b'):
	...
	def processTitle(self,data):
		regex=r'\b[1-9][0-9]{1,3}\b|\b[a-z]+\b'
